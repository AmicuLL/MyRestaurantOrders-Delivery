var API = {
    ...
    addMenu: function (id, name, description, price, src_img) {
        return this.api.post(`/restaurant/createMenu`,
            new URLSearchParams({ id, name, description, price, src_img }));
    },
    ...
    uploadFiles: function (file, path) {
        console.log("API.UPLOAD");
        return this.api.post(`/restaurant/upload`, file, new URLSearchParams({ path }), { headers: { 'Content-Type': 'multipart/form-data' } });
    }
